...
LANGUAGES = agda bash c c-sharp clojure cpp css elm go hack haskell html java javascript json kotlin latex markdown php python query ruby rust scala scss sparql talon tsx typescript yaml
